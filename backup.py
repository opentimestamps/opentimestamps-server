...
parser = argparse.ArgumentParser(description="OpenTimestamps Calendar Server Backupper")

parser.add_argument('-c', '--calendar', metavar='URL', action='append', type=str, default=[],
                    help='Add a calendar base url to backup.')
...
for c in args.calendar:
    ...
    try:
        ...
        last_known = -1
    print("Checking calendar " + str(c) + ", last_known commitment:" + str(last_known))
    # TODO ask from up_to
    backup_url = urljoin(c, "/backup")
    ...
    while True:
        ...
        try:
            ...
            print("Exception asking " + str(backup_url))
            continue
